# 🎬 Auto Video Render Script - Fixed Version
...
function Show-VideoList {
    ...
    Write-Info "Use: .\auto-render-fixed.ps1 -VideoId VIDEO_ID to render a specific video"
    Write-Info "Use: .\auto-render-fixed.ps1 -RenderAll to render all videos"
}
...
# 🎯 Main Execution
function Main {
    Write-Header "Auto Video Render Script - Fixed Version"
    ...
    if ($ListVideos) {
        ...
        Write-Host "  .\auto-render-fixed.ps1 -ListVideos" -ForegroundColor White
        Write-Host "  .\auto-render-fixed.ps1 -VideoId VIDEO_ID" -ForegroundColor White
        Write-Host "  .\auto-render-fixed.ps1 -RenderAll" -ForegroundColor White
        Write-Host ""
        Write-Host "Examples:" -ForegroundColor $Colors.Info
        Write-Host "  .\auto-render-fixed.ps1 -ListVideos" -ForegroundColor Gray
        Write-Host "  .\auto-render-fixed.ps1 -VideoId f04df512-ee66-48f2-b8e6-e2fac9f3e6da" -ForegroundColor Gray
        Write-Host "  .\auto-render-fixed.ps1 -RenderAll" -ForegroundColor Gray
    }
}
