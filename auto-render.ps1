...
function Show-Usage {
    ...
    Write-Host "  .\auto-render.ps1 -ListVideos" -ForegroundColor White
    Write-Host "  .\auto-render.ps1 -VideoId VIDEO_ID" -ForegroundColor White
    Write-Host "  .\auto-render.ps1 -RenderAll" -ForegroundColor White
    Write-Host ""
    Write-Host "Examples:" -ForegroundColor $Info
    Write-Host "  .\auto-render.ps1 -ListVideos" -ForegroundColor Gray
    Write-Host "  .\auto-render.ps1 -VideoId f04df512-ee66-48f2-b8e6-e2fac9f3e6da" -ForegroundColor Gray
    Write-Host "  .\auto-render.ps1 -RenderAll" -ForegroundColor Gray
}
